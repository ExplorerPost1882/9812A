...
#pragma config(Motor,  port6,           Arm1U,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           Arm2U,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           Claw1,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           Claw2,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          Arm2D,         tmotorVex393_HBridge, openLoop)
...
task usercontrol()
{
    while (true)
  {
		...
		motor[Arm1D] = vexRT[Ch1Xmtr2];
		motor[Arm2D] = vexRT[Ch1Xmtr2];
		motor[Arm1U] = vexRT[Ch1Xmtr2];
		motor[Arm2U] = vexRT[Ch1Xmtr2];
